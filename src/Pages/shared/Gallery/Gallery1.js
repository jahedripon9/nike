            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-5 mx-auto flex flex-wrap">
                    ...
                    <div className="flex flex-wrap lg:w-full lg:bg-gray-100 lg:py-72 px-28 relative mb-2 ">
                        <img alt="gallery" className="lg:w-full object-cover sm:h-full mt-10 object-center block opacity-100 absolute inset-0" src="https://i.ibb.co/MNZxcyd/men-s-shoes-clothing-accessories.jpg"/>
